...
First repo: We encourage you to use a conda environment installation following these \href{https://github.com/iit-DLSLab/Quadruped-PyMPC/blob/main/README_install.md}{README installation instructions}
Every time you open a new terminal, you need to activate the conda environment first, see the README!

Second repo: \href{https://github.com/giulioturrisi/ekf-legged-robot-pytorch}{EKF for Legged Robots}
